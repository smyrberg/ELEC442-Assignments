...
\begin{figure}[h!]
    \centering
    \includegraphics[width = .95\textwidth]{4_new.PNG}
...
\todo{put in jacobian calculation in code, do e)}
...
\lstinputlisting[style = Matlab-editor, firstline=5, lastline = 50, caption = MATLAB code used to generate homogenous transformation matrix for angles chosen by the user, captionpos = b, label = lst:5d1]{../../MATLAB/Assignment1/Ex5.m}
\begin{figure}[ht!]
    \centering
