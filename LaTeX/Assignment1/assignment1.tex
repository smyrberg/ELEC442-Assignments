...
\begin{equation} \label{eq:5btransformationchain} where $\prescript{0}{}{T}_6$ is a series of transformations on the form as shown in the first line of \eqref{eq:2a}, and we have the relationship between he base and the end effector. A chain of transformations that give the relationship between  base $\{\undertilde{\bm{o}_0} , \underline{C}_0\}$ and the end effector $\{\undertilde{\bm{o}_6} , \underline{C}_6\}$ in this exact case on the form presented by Salcudean's example 2.5 is
\begin{equation}
    \begin{aligned}
