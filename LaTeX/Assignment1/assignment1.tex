...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
where $\prescript{0}{}{T}_6$ is a series of transformations on the form as shown in \eqref{eq:2a}, and we have the relationship between he base and the end effector.
